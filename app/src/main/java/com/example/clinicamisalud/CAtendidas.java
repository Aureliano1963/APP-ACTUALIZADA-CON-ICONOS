...
ListView LisConsultas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String citasatendidas = ("https://apiapps.misalud.com.sv/listarconsultas/" + usuario + "/" + contraseña + "/" + 1);
        ...
        LisConsultas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View v, int i, long l) {
                ...
                String idExp = ("https://apiapps.misalud.com.sv/listarconsultas/" + usuario + "/" + contraseña + "/" + 1);
                ObtenerId(idExp);
            }
        });
